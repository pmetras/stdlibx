...
You want to contribute to bits? Awesome.
...
First of all please [search existing issues](https://github.com/pmetras/bits/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/pmetras/bits/issues/new).
